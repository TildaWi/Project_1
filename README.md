...
- **H1. 여름철 기온 상승과 고장률은 관련이 있다**  
  ↳ 8월 평균 기온 및 강수량과 고장 건수 간 상관관계 분석  

- **H2. 기존 정비 방식은 고장 예방 효과가 낮다**  
  ↳ 정비 이력 대비 고장 건수 비교 → 정비 후에도 반복 고장 발생  

- **H3. 특정 시간대(퇴근 시간)에 고장 신고가 집중된다**  
  ↳ 18~21시 사이에 전체의 40% 이상 신고 집중  
...
정량 분석을 통해 드러난 자치구별, 부품별, 시간대별 고장 패턴을 바탕으로  
운영팀이 즉시 실행 가능한 정비 전략을 제안하였습니다.
